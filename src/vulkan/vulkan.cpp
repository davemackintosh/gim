#include "gim/ecs/components/shader.hpp"
...
gim::systems::renderers::vulkan::VulkanApp::VulkanApp() {
	initWindow();
	initVulkan();
}

auto gim::systems::renderers::vulkan::VulkanApp::run() -> void {
	update();
	cleanup();
}

auto gim::systems::renderers::vulkan::VulkanApp::initWindow() -> void {
	SDLMustBeTrue(SDL_Init(SDL_INIT_EVERYTHING) == 0);

	window = SDL_CreateWindow(
		"Mountain", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, WIDTH,
		HEIGHT, SDL_WINDOW_VULKAN | SDL_WINDOW_RESIZABLE | SDL_WINDOW_SHOWN);
	SDLMustBeTrue(window != nullptr);
}

auto gim::systems::renderers::vulkan::VulkanApp::initVulkan() -> void {
	createInstance();
	createSurface();
	pickPhysicalDevice();
	createLogicalDevice();
...
auto gim::systems::renderers::vulkan::VulkanApp::update() -> void {
	auto waitForFences =
...
auto gim::systems::renderers::vulkan::VulkanApp::cleanupSwapChain() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::cleanup() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::recreateSwapChain() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createInstance() -> void {
	...
	auto appInfo =
		vk::ApplicationInfo("Mountain", VK_MAKE_VERSION(1, 0, 0), "Mountain",
	...
	auto createInfo = vk::InstanceCreateInfo(
		...
		&appInfo, 0, nullptr, // enabled layers
...
auto gim::systems::renderers::vulkan::VulkanApp::createSurface() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::pickPhysicalDevice() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createLogicalDevice() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createSwapChain() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createImageViews() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createRenderPass() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createGraphicsPipeline()
	-> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createFrameBuffers() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createCommandPool() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createVertexBuffer() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createBuffer(
...
auto gim::systems::renderers::vulkan::VulkanApp::copyBuffer(VkBuffer srcBuffer,
															VkBuffer dstBuffer,
															VkDeviceSize size)
	-> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::findMemoryType(
...
auto gim::systems::renderers::vulkan::VulkanApp::createCommandBuffers()
	-> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::createSyncObjects() -> void {
...
auto gim::systems::renderers::vulkan::VulkanApp::drawFrame() -> void {
	auto waitResult =
		device->waitForFences(1, &inFlightFences[currentFrame], VK_TRUE,
							  std::numeric_limits<uint64_t>::max());
...
auto gim::systems::renderers::vulkan::VulkanApp::createShaderModule(
...
auto gim::systems::renderers::vulkan::VulkanApp::chooseSwapSurfaceFormat(
...
auto gim::systems::renderers::vulkan::VulkanApp::chooseSwapPresentMode(
...
auto gim::systems::renderers::vulkan::VulkanApp::chooseSwapExtent(
...
auto gim::systems::renderers::vulkan::VulkanApp::querySwapChainSupport(
...
auto gim::systems::renderers::vulkan::VulkanApp::isDeviceSuitable(
...
auto gim::systems::renderers::vulkan::VulkanApp::checkDeviceExtensionSupport(
...
auto gim::systems::renderers::vulkan::VulkanApp::findQueueFamilies(
...
auto gim::systems::renderers::vulkan::VulkanApp::getRequiredExtensions()
...
auto gim::systems::renderers::vulkan::VulkanApp::checkValidationLayerSupport()
	-> bool {
...
auto gim::systems::renderers::vulkan::VulkanApp::readFile(
	const std::string &filename) -> std::vector<char> {
...
gim::systems::renderers::vulkan::VulkanApp::debugCallback(
...
auto gim::systems::renderers::vulkan::VulkanApp::getSignature()
	-> std::shared_ptr<gim::ecs::Signature> {
	auto signature = std::make_shared<gim::ecs::Signature>();
	signature->set<gim::ecs::components::Shader>();
